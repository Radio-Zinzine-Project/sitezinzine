...
class EmissionRepository extends ServiceEntityRepository
{
     ...
     * ]
     */
    public function findSpecialCandidatesForRegularCategory(
        Categories $category,
        ?int $limit = 20,
        string $search = ''
    ): array {
        ...
        return $this->normalizeSpecialCandidateRows(
            $qb->getQuery()->getResult()
        );
    }

    public function countSpecialCandidatesForRegularCategory(
        Categories $category,
        string $search = ''
    ): int {
        $qb = $this->createQueryBuilder('e')
     ...
     * ]
     */
    public function findSpecialCandidatesForNonRegularCategory(
        Categories $category,
        ?int $limit = 20,
        string $search = ''
    ): array {
    ...
    public function countSpecialCandidatesForNonRegularCategory(
        Categories $category,
        string $search = ''
    ): int {
        $qb = $this->createQueryBuilder('e')
