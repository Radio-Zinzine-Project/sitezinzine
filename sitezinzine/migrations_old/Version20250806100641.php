 ...
 */
final class Version20250806100641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD soft_delete TINYINT(1) NOT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories DROP soft_delete, DROP user_id');
    }
}
